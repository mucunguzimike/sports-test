...
* @route '/affiliate'
*/
export const affiliate = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: affiliate.url(options),
    method: 'get',
})
...
* @route '/affiliate'
*/
affiliate.url = (options?: RouteQueryOptions) => {
    return affiliate.definition.url + queryParams(options)
}
...
* @route '/affiliate'
*/
affiliate.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: affiliate.url(options),
    method: 'get',
})
...
* @route '/affiliate'
*/
affiliate.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: affiliate.url(options),
    method: 'head',
})
...
* @route '/affiliate'
*/
const affiliateForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: affiliate.url(options),
    method: 'get',
})
...
* @route '/affiliate'
*/
affiliateForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: affiliate.url(options),
    method: 'get',
})
...
* @route '/affiliate'
*/
affiliateForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: affiliate.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
