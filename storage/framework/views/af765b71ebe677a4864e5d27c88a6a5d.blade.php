...
- Run ___SINGLE_BACKTICK___{{ $assist->composerCommand('show inertiajs/inertia-laravel') }}___SINGLE_BACKTICK___ to confirm installed server version
- Identify all Inertia pages in ___SINGLE_BACKTICK___{{ $assist->inertia()->pagesDirectory() }}___SINGLE_BACKTICK___
...
- ___SINGLE_BACKTICK___{{ $assist->composerCommand('require inertiajs/inertia-laravel:^3.0') }}___SINGLE_BACKTICK___
@if($usesReact)
- ___SINGLE_BACKTICK___{{ $assist->nodePackageManagerCommand('install @inertiajs/react@^3.0') }}___SINGLE_BACKTICK___
@endif
@if($usesVue)
- ___SINGLE_BACKTICK___{{ $assist->nodePackageManagerCommand('install @inertiajs/vue3@^3.0') }}___SINGLE_BACKTICK___
@endif
@if($usesSvelte)
- ___SINGLE_BACKTICK___{{ $assist->nodePackageManagerCommand('install @inertiajs/svelte@^3.0') }}___SINGLE_BACKTICK___
@endif
- ___SINGLE_BACKTICK___{{ $assist->nodePackageManagerCommand('install @inertiajs/vite@^3.0') }}___SINGLE_BACKTICK___
- ___SINGLE_BACKTICK___{{ $assist->artisanCommand('vendor:publish --provider="Inertia\\\\ServiceProvider" --force') }}___SINGLE_BACKTICK___
- ___SINGLE_BACKTICK___{{ $assist->artisanCommand('view:clear') }}___SINGLE_BACKTICK___
...
Update your server-side adapter by running ___SINGLE_BACKTICK___{{ $assist->composerCommand('require inertiajs/inertia-laravel:^3.0') }}___SINGLE_BACKTICK___.
...
- ___SINGLE_BACKTICK___{{ $assist->nodePackageManagerCommand('install axios') }}___SINGLE_BACKTICK___
...
- ___SINGLE_BACKTICK___{{ $assist->nodePackageManagerCommand('install qs') }}___SINGLE_BACKTICK___
...
- ___SINGLE_BACKTICK___{{ $assist->nodePackageManagerCommand('install lodash-es') }}___SINGLE_BACKTICK___
...
The ___SINGLE_BACKTICK___config/inertia.php___SINGLE_BACKTICK___ file structure has changed. After upgrading, republish it with ___SINGLE_BACKTICK___{{ $assist->artisanCommand('vendor:publish --provider="Inertia\\\\ServiceProvider" --force') }}___SINGLE_BACKTICK___ and then re-apply any customizations on top of the new structure.
